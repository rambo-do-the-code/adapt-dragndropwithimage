	...
	var dragndropwithimage = QuestionView.extend({
		...
		placeDraggable: function($draggable, $droppable, animationTime) {
			...
			_.each(items, function (item, i) {
				var uniqueitem = $('.dragndropwithimage-component[data-adapt-id="' + component_id + '"] .dragndropwi-inner .dragndropwi-question[data-index="' + i + '"] .ui-state-disabled');
			...
			if (this.bounceBack == true || $('.dragndropwithimage-component[data-adapt-id="' + component_id + '"] .dragndropwi-inner .buttons').hasClass('bounceback') ) {
				...
				if (myuser0 == myitem0) {
					setTimeout(function() {
						$('.dragndropwithimage-component[data-adapt-id="' + component_id + '"] .dragndropwi-inner .dragndropwi-question[data-index="' + getindex + '"]').addClass('correct');
						$('.dragndropwithimage-component[data-adapt-id="' + component_id + '"] .dragndropwi-inner .dragndropwi-answer[name="' + myuser0 + '"]').remove();
						$('.dragndropwithimage-component[data-adapt-id="' + component_id + '"] .dragndropwi-inner .dragndropwi-question[data-index="' + getindex + '"] .ui-state-disabled[data-index="' + getindex + '"]').removeAttr('data-index');					
					}, animationTime);
					this.popupCorrect();
				} else {
					setTimeout(function() {
						$('.dragndropwithimage-component[data-adapt-id="' + component_id + '"] .dragndropwi-inner .dragndropwi-question[data-index="' + getindex + '"] .dragndropwi-droppable').removeClass('ui-state-disabled').removeClass('nomorespace').addClass('ui-state-enabled');
						$('.dragndropwithimage-component[data-adapt-id="' + component_id + '"] .dragndropwi-inner .dragndropwi-answer[name="' + myuser0 + '"]').animate($draggable.data().originalPosition, animationTime).removeClass("ui-state-placed").data("droppable", null);
					}, animationTime);
					this.popupIncorrect();
				}
			} else {
		...
		markAnswers: function() {
			...
			_.each(this.model.get("_items"), function(item) {
				...
				_.each(item.accepted, function (mraccepted) {
					...
					$('.dragndropwithimage-component[data-adapt-id="' + myownid + '"] .dragndropwi-inner .dragndropwi-item[name*="' + checkaccepted + '"]').addClass("dragcharm").text("For \n" + item.text);
		...
		resetQuestion: function() {
			...
			_.each(this.model.get("_items"), function(item, i){
				...
				_.each(item.accepted, function (mraccepted) {
					...
					$('.dragndropwithimage-component[data-adapt-id="' + myownid + '"] .dragndropwi-inner .dragndropwi-item[name*="' + accepted + '"]').removeClass("dragcharm").text(accepted);
				});
			});
		},
