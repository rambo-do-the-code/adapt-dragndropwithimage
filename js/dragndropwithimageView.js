      ...
      if (!isShowAnswer) {
        ...
        _.each(
          ...
          function (question, index) {
            const $container = $(
              '<div class="user-answer" style="padding: 10px; display: block; position: absolute; top: 43px; left: 23px; width: 100%; display: flex; gap: 10px; flex-wrap: wrap; z-index: 20;"></div>'
            );
